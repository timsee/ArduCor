...
#paths
PROJ_PATH="CorlumaSample.ino"
SAMPLES_PATH=../../samples/Corluma
...
function generate_hardware_specific_sample() 
{
    ...
    do
        WRITE_PROJ="${1}-${comm_id}-Corluma-Sample"
...
rm -r ${SAMPLES_PATH}/yun/http/Rainbowduino-HTTP-Corluma-Sample
rm -r ${SAMPLES_PATH}/yun/udp/Rainbowduino-UDP-Corluma-Sample
rm -r ${SAMPLES_PATH}/yun/http/Multi-HTTP-Corluma-Sample
rm -r ${SAMPLES_PATH}/yun/udp/Multi-UDP-Corluma-Sample
